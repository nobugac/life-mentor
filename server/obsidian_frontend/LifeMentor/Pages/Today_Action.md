...
const nightLink = actionRow.createEl("a", {
  ...
  text: "去晚间回顾 →",
  href: "LifeMentor/Pages/Night",
});
nightLink.setAttribute("data-href", "LifeMentor/Pages/Night");
...
<div class="lm-nav">
  ...
  <a class="internal-link lm-nav-link active" data-href="LifeMentor/Pages/Today_Action" href="LifeMentor/Pages/Today_Action">✅ Action</a>
